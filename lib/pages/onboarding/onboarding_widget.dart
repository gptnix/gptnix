...
class _OnboardingWidgetState extends State<OnboardingWidget>
                                      ...
                                      children: [
                                        Text(
                                          FFLocalizations.of(context).getText(
                                            'gkja1msn' /* Discover Intelligence with GPT... */,
                                          ),
                                        ...
                                        Text(
                                          FFLocalizations.of(context).getText(
                                            '63nnbdcv' /* GPTNiX unlocks smart insights ... */,
                                          ),
                                          textAlign: TextAlign.center,
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
 ...
 learn more */
                                        ...
                                        Text(
                                          FFLocalizations.of(context).getText(
                                            'htmqk0u0' /* Capture an image to get 
insta... */
                                            ,
                                          ),
                                          textAlign: TextAlign.center,
                                    ...
                                    Column(
                                      ...
                                      children: [
                                        Text(
                                          FFLocalizations.of(context).getText(
                                            '60eza0xk' /* Talk it out live with 
DeepSee... */
                                            ,
                                          ),
                                          textAlign: TextAlign.center,
                                        ...
                                        Text(
                                          FFLocalizations.of(context).getText(
                                            'bla16cph' /* Chat In real time with 
deepse... */
                                            ,
                                          ),
                                          textAlign: TextAlign.center,
...
Voice Ch... */
                                        ...
                                        Text(
                                          FFLocalizations.of(context).getText(
                                            'k5fjib8u' /* Enjoy seamsless conversations ... */,
                                          ),
                                          textAlign: TextAlign.center,
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
                        ...
                        FFButtonWidget(
                          ...
                          text: FFLocalizations.of(context).getText(
                            'wigngtwd' /* Get Started */,
                          ),
                          icon: Icon(
                            FFIcons.karrowRight44,
                            size: 30.0,
                          ),
