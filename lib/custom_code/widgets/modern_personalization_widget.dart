            ...
            children: [
              ...
              Padding(
                ...
                child: Wrap(
                  spacing: 10,
                  runSpacing: 10,
                  children: _availableCharacteristics.map((char) {
                    final isSelected = _characteristics.contains(char['id']);
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          _buildHelperText(
                              ...
                              isDark),
                          const SizedBox(height: 24),
                          _buildSectionTitle('Custom Instructions', isDark),
                          const SizedBox(height: 8),
                          _buildTextArea(
                            isDark,
                          ...
                          _buildNavigationTile(
                            ...
                            title: 'Memories',
                            subtitle: 'Things GPTNiX remembers about you',
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          GestureDetector(
            onTap: (_hasChanges && !_isSaving) ? _savePersonalization : null,
            child: Container(
              width: 40,
              height: 40,
              decoration: BoxDecoration(
          ...
          Wrap(
            ...
            children: _characteristics.map((charId) {
              final char = _availableCharacteristics.firstWhere(
                (c) => c['id'] == charId,
                orElse: () =>
                    {'id': charId, 'label': charId, 'icon': Icons.star_outline},
              );
              return Container(
                padding:
